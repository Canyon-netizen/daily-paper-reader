#!/usr/bin/env python
"""Init script for ICLR OpenReview — fetches submissions and syncs to Supabase.
...
def main() -> None:
    ...
    raw_filename = f"iclr-openreview-{year_start}-{year_end}.json"
    ...
    run_step("Step 2 - sync ICLR OpenReview to Supabase", build_sync_cmd(
        backend_key="iclr",
        date_str=date_str,
        raw_path=raw_path,
        args=args,
