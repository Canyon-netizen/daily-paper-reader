#!/usr/bin/env python
"""Init script for ICML OpenReview — fetches submissions and syncs to Supabase.
...
def main() -> None:
    ...
    raw_filename = f"icml-openreview-{year_start}-{year_end}.json"
    ...
    run_step("Step 2 - sync ICML OpenReview to Supabase", build_sync_cmd(
        backend_key="icml",
        date_str=date_str,
        raw_path=raw_path,
        args=args,
