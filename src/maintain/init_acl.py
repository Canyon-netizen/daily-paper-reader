#!/usr/bin/env python
"""Init script for ACL Anthology — fetches papers and syncs to Supabase.
...
def main() -> None:
    ...
    raw_filename = f"acl-anthology-{year_start}-{year_end}.json"
    ...
    run_step("Step 2 - sync ACL papers to Supabase", build_sync_cmd(
        backend_key="acl",
        date_str=date_str,
        raw_path=raw_path,
        args=args,
