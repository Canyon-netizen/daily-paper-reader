...
authors: Aofan Yu, Chenyu Zhou, Tianyi Xu, Zihan Guo, Rong Shan, Zhihui Fu, Jun Wang,
...
tldr: 现有LLM智能体将文本技能注入提示词，存在上下文开销大且暴露技能内容的问题。LatentSkill通过预训练超网络将文本技能转为即插即用的LoRA适配器，把技能知识存储于权重空间而非上下文。在ALFWorld和Search-QA上以显著更少的prefill
  token超越上下文技能基线，且生成技能LoRA具备结构化、可控、可组合的特性。
source: arxiv
...
figures_json: '[{"url": "assets/figures/arxiv/2606.06087v1/fig-001.webp", "caption":
  "", "page": 0, "index": 1, "width": 2818, "height": 1539}, {"url": "assets/figures/arxiv/2606.06087v1/fig-002.webp",
  "caption": "", "page": 0, "index": 2, "width": 2730, "height": 1024}, {"url": "assets/figures/arxiv/2606.06087v1/fig-003.webp",
  "caption": "", "page": 0, "index": 3, "width": 1160, "height": 1352}, {"url": "assets/figures/arxiv/2606.06087v1/fig-004.webp",
  "caption": "", "page": 0, "index": 4, "width": 7862, "height": 7773}, {"url": "assets/figures/arxiv/2606.06087v1/fig-005.webp",
  "caption": "", "page": 0, "index": 5, "width": 1002, "height": 859}]'
wiki_compiled: true
wiki_compiled_at: 2026-07-22 08:15:55.894224+00:00
concepts:
- slug: latentskill
  display_name: LatentSkill
  category: method
  novelty: 1.0
  centrality: 1.0
- slug: hypernetwork
...
method_pros_cons: {"LatentSkill": {"pros": ["ALFWorld成功率提升21.4/13.4点，token减少64.1%", "Search-QA EM提升3.0点，技能token开销降72.2%", "技能LoRA支持模块化加载、缩放与参数空间组合", "生成LoRA在权重空间形成可分离的语义几何结构"], "cons": ["需预训练超网络，增加训练成本与复杂度", "技能组合需预先将描述分解为对齐组件", "仅在ALFWorld与Search-QA两个任务验证，泛化待考"]}, "In-Context Skill Prompting": {"pros": ["简单、模块化，易于部署与更新", "无需额外训练，开箱即用", "被Claude Code等主流框架广泛采用"], "cons": ["每步注入skill文本，prefill成本随交互累积", "技能内容以明文暴露，存在隐私与安全风险", "长输入下模型难以稳健利用所有skill信息"]}, "Agent Fine-tuning / Curriculum Learning": {"pros": ["推理时无需插入skill文本，零样本执行", "可内化复杂技能到模型参数"], "cons": ["技能不可逆融合到骨干参数，难以更新移除", "丧失模块化加载与组合灵活性", "需要大量训练数据和计算资源"]}}
method_comparison: "LatentSkill通过超网络将文本技能转化为LoRA权重，既消除了上下文开销又保留了模块化灵活性，在效率与模块化间取得平衡，优于纯文本上下文技能和完全参数融合的微调方案。"
method_debate_generated_at: "2026-09-01T11:58:13.931710Z"
