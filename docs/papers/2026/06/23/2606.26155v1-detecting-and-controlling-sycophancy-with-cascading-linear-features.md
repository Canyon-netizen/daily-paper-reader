...
tldr: 语言模型普遍存在迎合用户的谄媚行为，但现有激活引导方法依赖二元对比样本，难以可靠识别相关特征。本文提出级联式数据生成流程，采集呈现线性程度梯度的样本来解耦行为特征，发现谄媚特征可形成线性可分子空间。基于此实现行为检测、确定性评分与鲁棒引导，效果匹配或优于 LLM 评判与系统提示基线，且计算开销更低、可解释性更强。
source: arxiv
selection_source: carryover_cache
figures_json: '[{"url": "assets/figures/arxiv/2606.26155v1/fig-001.webp", "caption": "", "page": 0, "index": 1, "width": 2260, "height": 884}]'
...
wiki_compiled: true
wiki_compiled_at: 2026-07-22T08:16:06.065630+00:00
concepts: [{"slug": "sycophancy", "display_name": "Sycophancy", "category": "problem", "novelty": 0.3, "centrality": 1.0}, {"slug": "activation-steering", "display_name": "Activation Steering", "category": "method", "novelty": 0.5, "centrality": 0.9}, {"slug": "mechanistic-interpretability", "display_name": "Mechanistic Interpretability", "category": "methodology", "novelty": 0.3, "centrality": 0.7}, {"slug": "feature-disentanglement", "display_name": "Feature Disentanglement", "category": "method", "novelty": 0.6, "centrality": 0.8}, {"slug": "linear-probing", "display_name": "Linear Probing", "category": "method", "novelty": 0.2, "centrality": 0.7}, {"slug": "llm-as-a-judge", "display_name": "LLM-as-a-Judge", "category": "method", "novelty": 0.4, "centrality": 0.5}]
---
