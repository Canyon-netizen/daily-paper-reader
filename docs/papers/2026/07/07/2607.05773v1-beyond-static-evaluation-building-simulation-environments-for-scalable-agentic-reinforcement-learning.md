...
tldr: 随着大模型向自主智能体演进，传统静态评测难以捕捉多步决策过程。本文提出AgenticAI-Supervisor，一个基于API与UI驱动的强化学习仿真环境，通过解耦环境构建与可扩展执行，依托可验证执行结果生成高保真轨迹并采用多维奖励塑形。内部状态校验机制有效缓解了reward hacking问题，客服Agent案例展示了闭环反馈的稳定性。该平台为agentic RL的可扩展训练与评估提供了基础设施支撑。
source: arxiv
selection_source: fresh_fetch
figures_json: '[{"url": "assets/figures/arxiv/2607.05773v1/fig-001.webp", "caption": "", "page": 0, "index": 1, "width": 2048, "height": 1109}, {"url": "assets/figures/arxiv/2607.05773v1/fig-002.webp", "caption": "", "page": 0, "index": 2, "width": 2738, "height": 1038}]'
motivation: LLM向自主智能体演进，传统静态评测难以刻画多步决策过程，亟需可扩展、可验证的RL训练仿真环境。
method: 基于API/UI驱动的RL Gym仿真环境，解耦环境创建与可扩展执行；通过可验证执行结果生成高保真轨迹，结合多维奖励塑形与内部状态校验缓解reward hacking。
...
wiki_compiled: true
wiki_compiled_at: 2026-07-22T08:35:24.928196+00:00
concepts: [{"slug": "agentic-reinforcement-learning", "display_name": "Agentic Reinforcement Learning", "category": "problem", "novelty": 0.3, "centrality": 1.0}, {"slug": "reward-hacking", "display_name": "Reward Hacking", "category": "problem", "novelty": 0.0, "centrality": 0.9}, {"slug": "reward-shaping", "display_name": "Reward Shaping", "category": "method", "novelty": 0.0, "centrality": 0.9}, {"slug": "llm-as-a-judge", "display_name": "LLM-as-a-Judge", "category": "methodology", "novelty": 0.1, "centrality": 0.6}, {"slug": "rl-gym-environment", "display_name": "RL Gym Environment", "category": "architecture", "novelty": 0.0, "centrality": 0.9}, {"slug": "gui-driven-agent-simulation", "display_name": "GUI-driven Agent Simulation", "category": "architecture", "novelty": 0.2, "centrality": 0.6}, {"slug": "model-context-protocol", "display_name": "Model Context Protocol", "category": "other", "novelty": 0.2, "centrality": 0.4}]
---
