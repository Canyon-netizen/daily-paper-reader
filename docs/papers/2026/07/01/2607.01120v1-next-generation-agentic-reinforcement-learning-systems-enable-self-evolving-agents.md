...
authors: Ran Yan, Wei Fu, Jiale Li, Shusheng Xu, Zhiyu Mei, Jiaxuan Gao, Jiarui Zhang,
  Xujie Shen, Hao Dai, Chuyi He, Zhen Pu, Jun Mei, Zhiyao Lin, Haitao Wang, Zhiqiang
  Ding, Jiawei Zhang, Huaijie Wang, Ruida Xu, Youhe Jiang, Yi Wu, Tongkai Yang, Binhang
  Yuan
date: 2026-07-01
...
figures_json: '[{"url": "assets/figures/arxiv/2607.01120v1/fig-001.webp", "caption":
  "", "page": 0, "index": 1, "width": 2223, "height": 1143}, {"url": "assets/figures/arxiv/2607.01120v1/fig-002.webp",
  "caption": "", "page": 0, "index": 2, "width": 2480, "height": 1131}]'
...
wiki_compiled: true
wiki_compiled_at: '2026-08-04T01:21:20+00:00'
concepts:
...
- slug: self-evolving-agent
  display_name: Self-Evolving Agent
  category: problem
  novelty: 0.4
  centrality: 1.0
...
method_pros_cons: {"Agent Trajectory Data Protocol (ATDP)": {"pros": ["支持跨异构agent范式的步级RL信号", "供应商中立、标准化协议", "使部署agent经验可学习而非仅可观测", "携带细粒度信用分配信息"], "cons": ["需跨厂商协调标准化难度大", "当前agent日志缺少步级信号", "仅是协议层面尚需系统级落地"]}, "Enterprise Data Proxy": {"pros": ["将真实工作负载转为受治理学习语料", "支持权限、合规与审计边界", "可重放便于离线分析与训练"], "cons": ["需处理多租户与跨团队数据隔离", "客户数据泄露风险带来治理负担", "实时转换带来额外系统开销"]}, "Agent Evolution Control Plane": {"pros": ["基于轨迹统计自动触发更新决策", "统一调度权重更新与harness编辑", "支持多种受治理更新路径选择"], "cons": ["自动触发策略设计复杂且风险高", "需要可靠统计信号否则易误触发", "更新机制多样增加系统耦合度"]}, "AReaL2.0": {"pros": ["重组现有RL基础设施为在线闭环", "面向已部署agent工作负载的权重更新", "开源提供可复现实现路径"], "cons": ["仅实现三大支柱之一的策略权重分支", "作为实例化分支覆盖范围有限", "依赖现有RL基础设施改造"]}, "OpenClaw / OpenClaw-RL": {"pros": ["展示持久化用户级agent自我进化能力", "支持跨应用任务执行的持续学习", "提供轨迹反思与自反馈机制"], "cons": ["面向个人用户而非企业级规模", "缺乏企业级合规与多租户治理", "算法特定的自我改进泛化性不足"]}}
method_comparison: "AReaL2.0作为策略权重更新的实例化分支，与ATDP、数据代理和控制平面三支柱共同构成下一代agentic RL系统；相比OpenClaw的个人级自进化，本文框架更强调企业级规模、合规治理与系统化闭环设计。"
method_debate_generated_at: "2026-09-01T12:18:57.803807Z"
