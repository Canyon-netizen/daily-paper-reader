...
method_pros_cons: {"Role-Based Multi-Agent Code Generation": {"pros": ["在仓库级任务上比单LLM更有效", "生成代码与开发者代码相似度更高", "适合处理超越小规模编程的复杂任务", "通过角色分工提升LLM协作能力"], "cons": ["与人类实现仍存在持续差距", "在12个Java仓库上的评估范围有限", "多智能体协作带来额外计算开销", "仅评估Java语言，泛化性待验证"]}, "Single LLMs": {"pros": ["架构简单，无需多智能体协调", "部署和推理成本较低", "无需角色分配和通信开销"], "cons": ["在仓库级问题上效果有限", "生成代码与开发者代码相似度较低", "难以处理超出小任务的复杂需求", "缺乏多视角协作推理能力"]}}
method_comparison: "本文对比了基于角色的多智能体代码生成与单LLM在仓库级任务上的表现，发现多智能体方法生成的代码更接近开发者风格，但仍落后于人类实现。"
method_debate_generated_at: "2026-09-01T12:26:46.292182Z"
